...
/**
 * "Documents" home — the signed-in user's document list, shown inside the
 * dashboard shell (the surrounding layout provides the sidebar + chrome and
 * already gated auth). Every document comes from `listDocuments()`, which is
 * RLS-scoped to this user (A01).
 */
